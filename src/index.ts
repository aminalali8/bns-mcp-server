...
/**
 * Definition of the Bunnyshell MCP Tool.
 * This tool ... TBD
 */
const BUNNYSHELL_MCP_TOOL: Tool = {
  name: "bns-control-panel",
  description:
    "Bunnyshell Control Panel",
  inputSchema: {
    type: "object",
    properties: {
      messages: {
...
// Retrieve the BUNNYSHELL TOKEN from environment variables
const BUNNYSHELL_TOKEN = process.env.BUNNYSHELL_TOKEN;
if (!BUNNYSHELL_TOKEN) {
  console.error("Error: BUNNYSHELL_TOKEN environment variable is required");
  process.exit(1);
}
