...
export function setupPrompts(server: McpServer): void {
  ...
  server.prompt(
    "create-environment",
    "Guide for creating a new environment in Bunnyshell",
    async (extra) => {
...
Once you provide these details, I'll guide you through the environment creation process.`
  ...
  server.prompt(
    "deploy-component",
    "Guide for deploying a component in a Bunnyshell environment",
    async (extra) => {
      return {
...
Once you provide these details, I'll guide you through the component deployment process.`
  ...
  server.prompt(
    "troubleshoot",
    "Common issues and resolutions for Bunnyshell",
    async (extra) => {
      return {
...
Once you tell me what type of issue you're having, I'll provide appropriate troubleshooting steps.`
  ...
  server.prompt(
    "setup-remote-dev",
    "Guide for setting up remote development with Bunnyshell",
    async (extra) => {
      return {
...
Once you provide these details, I'll guide you through the remote development setup process.`
  ...
  server.prompt(
    ...
    "Detailed workflow for creating a Bunnyshell environment",
    async (extra) => {
      return {
...
Would you like me to help you execute any of these commands?`
  ...
  server.prompt(
    ...
    "Detailed workflow for deploying a component in Bunnyshell",
    async (extra) => {
      return {
...
Would you like me to help you execute any of these commands?`
  ...
  server.prompt(
    ...
    "Troubleshooting guide for Bunnyshell deployment issues",
    async (extra) => {
      return {
...
3. **Container crashes on startup**
  ...
  server.prompt(
    ...
    "Troubleshooting guide for Bunnyshell connection issues",
    async (extra) => {
      return {
...
3. **Cannot connect to remote development environment**
  ...
  server.prompt(
    "remote-dev-workflow",
    "Detailed workflow for setting up remote development",
    async (extra) => {
      return {
