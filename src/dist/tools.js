 ...
 */
function setupOrganizationTools(server) {
    // List organizations
 ...
 */
function setupProjectTools(server) {
    // List projects
 ...
 */
function setupEnvironmentTools(server) {
    // List environments
    server.tool("list-environments", {
    ...
    // Create environment
    server.tool("create-environment", {
    ...
    // Delete environment
    server.tool("delete-environment", {
 ...
 */
function setupComponentTools(server) {
    // List components
    server.tool("list-components", {
 ...
 */
function setupVariableTools(server) {
    // List variables
    server.tool("list-variables", {
        environment: z.string().optional().describe("Environment ID"),
        filter: z.string().optional().describe("Filter expression"),
        limit: z.number().optional().describe("Maximum number of items to return")
    }, async ({ environment, filter, limit }) => {
 ...
 */
function setupRemoteDevTools(server) {
    // Start remote development
    server.tool("start-remote-dev", {
