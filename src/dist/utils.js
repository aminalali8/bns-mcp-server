 ...
 */
export async function execBnsCommand(command, options = { json: true, nonInteractive: true }) {
    try {
 ...
 */
export function formatOutput(stdout, stderr, command, needsToken) {
    let output = "";
    if (needsToken) {
 ...
 */
export function parseJsonResponse(stdout) {
    try {
 ...
 */
export function extractTokenFromMessage(message) {
 ...
 */
export async function runBnsCommand(args, token) {
